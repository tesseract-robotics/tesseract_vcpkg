...
vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}/tesseract_geometry
    PREFER_NINJA
    OPTIONS
...
vcpkg_cmake_config_fixup(PACKAGE_NAME "tesseract_geometry"
                         CONFIG_PATH "lib/cmake/tesseract_geometry")
vcpkg_fixup_pkgconfig()

file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/debug")
file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/lib")

file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/tesseract-geometry RENAME copyright)